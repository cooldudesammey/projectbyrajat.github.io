...
if (isset($_POST['submit'])) {
	...
	if(empty($Category)){
		$_SESSION['ErorMessage']="All fields must be filled out.";
		Redirect_to('categories.php');
	}elseif (strlen($Category)>99) {
		$_SESSION['ErorMessage']="Too long name..";
		Redirect_to('categories.php');
		
	}else{
		include('include/dbcon.php');
		$query = "INSERT INTO category(datetime, name, creatorname) VALUES ('$date_time','$Category','$admin')";
		...
		$_SESSION['ErorMessage']="Category failed to add..";
		Redirect_to('categories.php');
		}
	}
}
					...
					<div class="col-sm-10">
						...
						<div>
							<form action="categories.php" method="post">
								<fieldset>
									<div class="form-group">
										<label for="categoryname"><span class="font-weight-bold">Name:</span> </label>
										<input type="text" name="category" placeholder="type the name" class="form-control">
									</div>
									<br>
									<input type="submit" name="submit" value="Add new category" class="btn btn-info btn-block">
								</fieldset>
							</form>
							</div><!-- form div ends -->
							<div>
							...
							<div id="footer">
								...
								<h6>Created By | Rajat Kumar Singh | &copy2019 All right reerved.</h6>
